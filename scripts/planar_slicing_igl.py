...
def create_planar_paths_igl(mesh, min_z, max_z, planes):
    ...
    save_to_json(data=iso, filepath='/examples/WIP/wip_curved_slicing_surface/data/',
                 name='iso.json')
    ...
    save_to_json(data=es, filepath='/examples/WIP/wip_curved_slicing_surface/data/',
                 name='es.json')
    ...
    save_to_json(data=layers, filepath ='/examples/WIP/wip_curved_slicing_surface/data/', name='isolines.json')
