...
def main():
    ...
    parameters = {
        'target_LOW_smooth_union': [True, 5],  # boolean, blend_radius
        'target_HIGH_smooth_union': [True, 5],  # boolean, blend_radius
    ...
    preprocessor.targets_laplacian_smoothing(iterations=10, lamda=0.05)
