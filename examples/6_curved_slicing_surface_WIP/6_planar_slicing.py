...
OBJ_INPUT_NAME = os.path.join(DATA_PATH, 'bunny_low_res.obj')

start_time = time.time()

def main():
    ### --- Load stl
    compas_mesh = Mesh.from_obj(os.path.join(DATA, '_mesh.obj'))
    ### --- Move to origin
    ...
    save_to_json(slicer.to_data(), DATA, 'slicer_data_layers1.json')
